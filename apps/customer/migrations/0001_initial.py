    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preapproved_at', models.DateTimeField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(limit_value=datetime.datetime(2024, 5, 30, 19, 13, 18, 603589, tzinfo=datetime.timezone.utc))])),
